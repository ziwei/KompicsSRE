...
import util.DynamicComponentLoader;
...
public class StorletInitSample {
	...
	public static Storlet createSampleStorlet() throws IOException, StorletException, ClassNotFoundException, URISyntaxException, InstantiationException, IllegalAccessException {
		...
		JarInJarClassLoader jijLoader = new JarInJarClassLoader(new URL("file:///home/ziwei/workspace/KompicsSRE/nest.jar"), Thread.currentThread().getContextClassLoader());
		jijLoader.searchAndAddNestedJars();
		@SuppressWarnings("unchecked")
		Class<? extends Storlet> storletClass = (Class<? extends Storlet>) jijLoader.findClass("storlets4testing.HelloFileStorlet");
		//@SuppressWarnings("unchecked")
		//Class<? extends Storlet> innerClass = (Class<? extends Storlet>) jijLoader.findClass("storlets4testing.HelloFileStorlet$1");
		System.out.println("class loaded");
		//System.setSecurityManager(null);

		sl = Storlet.createStorlet(storletClass, dir1,
				contentCentricUrl);
