...
public class MemoryWarningSystem {
    ...
    public interface Listener {
        ...
        void memoryUsageLow(long concumedMemory);
    }
    ...
    private long initUsedMemory = tenuredGenPool.getUsage().getUsed();
...
//                    long maxMemory = tenuredGenPool.getUsage().getMax();
                    long currentUsedMemory = tenuredGenPool.getUsage().getUsed();
                    for (Listener listener : listeners) {
                        listener.memoryUsageLow(currentUsedMemory - initUsedMemory);
                    }
                }
            }
        }, null, null);
